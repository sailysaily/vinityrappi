class WinesController < ApplicationController
  ...
  private
    ...
    def wine_params
      params.require(:wine).permit(:name, :winery, :rating, :region, :grapes, :color, :wine_style, :food_pairing, :year, :story, :backgroud_image, :price, :photo, :country_photo, :price_cop, :availability)
    end
end
